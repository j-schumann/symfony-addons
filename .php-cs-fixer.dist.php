...
$finder = PhpCsFixer\Finder::create()
    ->in(['src', 'tests'])
    ->exclude('var/cache')
    // Auto-generated by the framework bundle. phpdoc_no_alias_tag rewrites the "@type" of a
    // documented Mercure option to "@var" in there, which corrupts the description.
